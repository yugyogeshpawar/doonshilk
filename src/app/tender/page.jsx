            ...
            {data == null || data == '' ? '' :
              data.map((info) => {
                return (
                  <>
                    {
                      info.criteria == 2 && info.datatype === 1 && info.is_active === true ? <DownloadTender url={info.file} text={info.text} /> : ''}
            ...
            {data == null || data == '' ? '' :
              data.map((info) => {
                return (
                  <>
                    {
                      info.criteria == 1 && info.datatype === 1 && info.is_active === true ? <DownloadTender url={info.file} text={info.text}/> : ''}
