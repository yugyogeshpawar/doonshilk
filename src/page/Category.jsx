      ...
      <CardBody>
        ...
        <Row>
          <Col>
            ...
            <Input type="textarea" rows="3" value={description} onChange={(e) => {
...
function UpdateModal(props) {
  ...
  const update = () => {
    ...
    axios.post(`${baseUrl}update-categories`, {
      category_name: props.updateName, description: props.updateDescription,
      category_id: props.selectedRows.category_id
    }).then(
      (response) => {
        if (response.status) {
